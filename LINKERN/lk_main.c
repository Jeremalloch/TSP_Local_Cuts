...
int main (int ac, char **av)
{
    ...
    double val, best;
    double startzeit;
    int tempcount, *templist = (int *) NULL;
    ...
    if (tsplib_in) {
        rval = CCutil_gettsplib (nodefile, &ncount, &dat);
        ...
        rval = CCutil_getdata (nodefile, binary_in, norm, &ncount, &dat,
    ...
    if (number_runs) {
        ...
        do {
            ...
            if (val < best) {
                best = val;
                if (saveit_final) {
                    rval = CCutil_writecycle_tsplib (ncount, saveit_final,
                             outcycle, (int *) NULL, &dat);
                    CCcheck_rval (rval, "CCutil_writecycle_tsplib failed");
/*
