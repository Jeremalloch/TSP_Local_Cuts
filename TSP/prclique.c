...
/*      CCtsp_tighten_info *stats, double *fullzeit, double *outviol)       */
...
/*     -fullzeit set to run time in seconds                                 */
/*     -outviol set to maximum violation found                              */
/*                                                                          */
/****************************************************************************/
        ...
        int fullncount, CCptrworld *intptr_world)
{
    ...
    for (myrnd = 0; myrnd < 2 && cut == (CCtsp_lpcut_in *) NULL; myrnd++) {
        for (i = 0; i < hcount; i++) {
            scanned[i] = 0;
        }
        scanhead = 0;
