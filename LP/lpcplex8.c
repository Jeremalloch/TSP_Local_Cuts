...
/****************************************************************************/
/*                                                                          */
/*              Interface Routines to The CPLEX 8.0 to 11.0 LP Solvers          */
/*                                                                          */
/*  NOTE: Use this code in place of lp_none.c to access the Cplex 8 to 11   */
...
static int set_parameters (CPXENVptr cplex_env, CClp_parameters *params)
{
    ...
    rval = CPXsetintparam (cplex_env, CPX_PARAM_BARTHREADS, 2);
    if (rval) {
        fprintf (stderr, "CPXsetintparam CPX_PARAM_BARTHREADS failed\n");
        goto CLEANUP;
    }
