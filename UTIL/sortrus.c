...
/*    n - the number of elements in perm and len.                           */
/*                                                                          */
/*  void CCutil_int_partperm_quicksort (int *perm, int *len, int n)         */
/*    perm - must be allocated and initialized by the calling routine,      */
/*    it will return a partial permutation in increasing order of len.      */
/*    n - the number of elements in perm and len.                           */
/*                                                                          */
/*                                                                          */
...
static void
    ...
    work_double_perm_quicksort (int *perm, double *len, int n),
...
void CCutil_double_perm_quicksort (int *perm, double *len, int n)
{
    ...
    for (i = 0; i < n; i++) perm[i] = i;
    work_double_perm_quicksort (perm, len, n);
}

static void work_double_perm_quicksort (int *perm, double *len, int n)
{
    int i, j, temp;
    double t;
    ...
    work_double_perm_quicksort (perm, len, j);
    work_double_perm_quicksort (perm + i, len, n - i);
}
